...
//                }).create().show();
    ...
    public void attemptLogin() {
        ...
        if (cancel) {
            ...
            Map<String, Object> aqParams = new HashMap<String, Object>();
            aqParams.put("email", email);
            aqParams.put("password", password);
            aqParams.put("gcmid", UsersData.getInstance().getGcmId());

            aq.ajax("http://oroktestapp.appspot.com/get_user", aqParams, JSONObject.class, new AjaxCallback<JSONObject>() {
